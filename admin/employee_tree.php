										...
										?>
	                                   	<ul>
                                    	    <li style="margin-top:15px !important">  
                                                <a href="#">
													<img src="security_staff_images/securityOfficers/<?php echo $result['off_img_name'];?>" height="50" width="50">
                                                    <br />
                                                ...
                                                <ul>
                                                    ...
                                                    ?>
                                                        <li>
                                                            <a href="#">
																<img src="security_staff_images/Staff_employee/<?php echo $row['staf_img_name'];?>" height="50" width="50">
                                                                <br />
