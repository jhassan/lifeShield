                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                    	$SQL = "SELECT * FROM departments ORDER BY depart_id DESC";			
    									$result = MySQLQuery($SQL);
    									while($row = mysqli_fetch_array($result)) { // ,MYSQL_ASSOC
    								?>
                                        <tr class="odd gradeX" id="DelID_<?php echo $row['depart_id'];?>">
                                            <td class="center"><?php echo $row['depart_id'];?></td>
                                            <td class="center"><?php echo $row['depart_name'];?></td>
                                            <td class="center"><a href="add_department?id=<?php echo $row['depart_id'];?>"><img height="16" width="16" src="../images/edit.png" alt="Edit"></a>&nbsp;&nbsp;&nbsp;<a id="<?php echo $row['staf_id'];?>" class='clsDelete'><img data-target="#myModal" data-toggle="modal" src="../images/delete.png" height="16" width="16" alt="Delete"></a></td>
                                        </tr>
									<?php } ?>
